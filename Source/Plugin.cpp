...
String hise::FrontendHandler::getProjectName() { return "Wav Sampler"; };
String hise::FrontendHandler::getCompanyName() { return "Wav Directory"; };
String hise::FrontendHandler::getCompanyWebsiteName() { return "https://wav.directory"; };
String hise::FrontendHandler::getCompanyCopyright() { return "(c)2025, Wav Directory"; };
